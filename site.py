...
with coll1:
    st.image(f"./pic/cr7.jpg",
        width=180,) # Set width of each image 

with coll2:
   st.image(f"./pic/cr7_moja.jpg",
        width=180,) # Set width of each image 
with coll3:
   st.image(f"./pic/wave_crop.jpg",
        width=180,) # Set width of each image 
...
if start_btn:
    if uploaded_style_image and uploaded_content_image :
        ...
        col3.image(result, caption='Styled Image')
           
        # Try it again button
        try_again=st.button("Try it again")
        if try_again:
...
with col1:
    st.image("./pic/green.jpg",
        width=170,) # Set width of each image 
with col2:
   st.image("./pic/1.jpg",
        width=170,) # Set width of each image 
with col3:
   st.image("./pic/brifge.jpg",
        width=170,) # Set width of each image 
with col4:
   st.image("./pic/2.jpg",
        width=170,) # Set width of each image 
